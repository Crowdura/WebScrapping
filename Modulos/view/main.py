...
class ScreenPrin(custoM.CTk):
    ...
    def hadlderEvent(self):
        ...
        lv_context = f"Validar cuales no se tenga rating. Resume los resultados obtenidos. Validar cual tiene mejor precio calidad. Cuando se haga una referencia hacer uso de la lista datosLinkComp para la obtención del link. Repuesta en idioma Español.: {lo_df}, datosLinkComp:{lo_df['link'].to_list()}"
